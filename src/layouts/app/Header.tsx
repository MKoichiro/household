...
import { useContextMenu } from '@ui/ContextMenu/hooks/useContextMenus'
import type { ContextMenuConfig } from '@ui/ContextMenu/types'
import { MenuIcon, MenuOpenIcon, MoreVertIcon } from '@shared/icons'
...
const AppHeader = ({ onMenuToggleClick: handleMenuToggleClick, isNavigationMenuOpen }: AppHeaderProps) => {
