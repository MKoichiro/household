...
const SignUp = () => {
  ...
  return (
    <Container maxWidth="xs">
      ...
      />
      <Button variant="contained" color="primary" fullWidth onClick={() => void handleSignup(email, password)}>
        アカウント作成
      </Button>
      <Button color="secondary" fullWidth onClick={() => void navigate('/auth/login')} sx={{ mt: 2 }}>
        ログインはこちら
      </Button>
    </Container>
  )
