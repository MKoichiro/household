...
import { ExpenseCategory, expenseLiterals, ExpenseTransaction, IncomeCategory, incomeLiterals, IncomeTransaction, Transaction, TransactionType } from '../types';
    ...
    <Box sx={{display: "flex", flexDirection: "column", flexGrow: 1}}>
      <FormControl sx={{alignItems: "center"}}>
        ...
        <RadioGroup
          ...
          row
        >
          <FormControlLabel value="expense" control={<Radio sx={{ color: theme.palette.expenseColor.main, '&.Mui-checked': { color: theme.palette.expenseColor.main } }} />} label="支出" />
          <FormControlLabel value="income" control={<Radio sx={{ color: theme.palette.incomeColor.main, '&.Mui-checked': { color: theme.palette.incomeColor.main } }} />} label="収入" />
        </RadioGroup>
      </FormControl>
